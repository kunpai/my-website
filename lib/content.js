...
export function themeCss() {
    ...
    if (accentColor) {
        ...
        // html-qualified so these beat Bootstrap's own :root / [data-bs-theme] declarations.
        rules.push(`html:root,html[data-bs-theme]{--brand-accent:${accentColor};--bs-primary:${accentColor};--bs-primary-rgb:${hexToRgb(accentColor)};` +
